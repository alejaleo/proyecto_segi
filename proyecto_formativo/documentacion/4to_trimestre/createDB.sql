...
CREATE TABLE IF NOT EXISTS `mydb`.`personas` (
  ...
  INDEX `fk_personas_usuarios1_idx` (`usuarios_idusuarios` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`peticiones` (
  ...
  INDEX `fk_peticiones_personas1_idx` (`personas_idpersonas` ASC, `personas_usuarios_idusuarios` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`mantenimientos` (
  ...
  INDEX `fk_mantenimientos_peticiones1_idx` (`peticiones_idpeticiones` ASC, `peticiones_usuarios_idusuarios` ASC) VISIBLE,
